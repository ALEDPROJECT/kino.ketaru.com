...
def inform(имя, возраст, изображение, кнопка, видео):
    return cn.print(
        ...
        f'{E}   Название фильма: {имя}\n'
        f'{E}   Возрастное ограничение: {возраст}\n\n'
        
        f'{E}   URL Изображения: {изображение}\n'
        f'{E}   URL Информация: {кнопка}\n'
        f'{E}   URL Видео: {видео}\n\n'
)
...
Имя = ''; Имя1 = f'{B}-'
Возраст = ''; Возраст1 = f'{B}-'
Изображение = ''; Изображение1 = f'{B}-'
Кнопка = ''; Кнопка1 = f'{B}-'; Button = ''
Видео = ''; Видео1 = f'{B}-'
...
while True:
    ...
    if Изображение in ['1', 'file', 'File', 'FILE', 'файл', 'Файл', 'ФАЙЛ']:
        ...
        try:
            ...
            Изображение1 = f'{D}[link={Изображение}]Ссылка[/link]'
            imgLOG = '3'
            break
        except:
...
while Кнопка in '':
    ...
    if Кнопка == '':
        ...
        Кнопка1 = f'{Y}[link={Кнопка}]Ссылка[/link] {B}'
