...
class app:
    _1_Print  = f'{IA}{R}┌────────────────────────────────────{A*3}{E} Панель разработчка {R}─{R}┐'
    _2_Print  = f'{IA}{R}│{W} Папок: {Y}{nun}                                            {O*2}{R}│'
    _3_Print  = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
    _4_Print  = f'{IA}{B} Для начала настройки сайта                          {Y}Нажмите: {D}Enter'
    _0_Input  = f''

    _11_Print = f'{IA}{R}┌────────────────────────────────────────────{A*3}{E} Коментарий {R}─{R}┐'
    _12_Print = f'{IA}{R}│{I} Значения: {G}Любой текст                                   {O*3}{R}│'
    _13_Print = f'{IA}{R}│{E} └{Q} Требуется обязательно!                                {O*3}{R}│'
    _14_Print = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
    _1_Name   = f'{IA}{B} Название'
    _1_Input  = f'{IA}{E} └ {I}Значение: '

    _21_Print = f'{IA}{R}┌────────────────────────────────────────────{A*3}{E} Коментарий {R}─{R}┐'
    _22_Print = f'{IA}{R}│{I} значения: {G}0+, 6+, 12+, 16+, 18+                         {O*3}{R}│'
    _23_Print = f'{IA}{R}│{E} └{Y} По умолчанию: {G}0+                                   {O*4}{R}│'
    _24_Print = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
    _2_Name   = f'{IA}{B} Возрастное ограничение'
    _2_Input  = f'{IA}{E} └ {I}Значение: '

    _31_Print = f'{IA}{R}┌────────────────────────────────────────────{A*3}{E} Коментарий {R}─{R}┐'
    _32_Print = f'{IA}{R}│{I} Значения: {G}Команда {Q}file {W}или {G}https://example.com {O*6}{R}│'
    _33_Print = f'{IA}{R}│{E} └{Y} По умолчанию: {G}Нет                                  {O*4}{R}│'
    _34_Print = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
    _3_Name   = f'{IA}{B} Изображение'
    _3_Input  = f'{IA}{E} └ {I}Значение: '
    _33_Input = f'{IA}{E}   └ {I}URL Изображения: '

    _41_Print = f'{IA}{R}┌────────────────────────────────────────────{A*3}{E} Коментарий {R}─{R}┐'
    _42_Print = f'{IA}{R}│{I} Значения: {G}https://example.com                           {O*3}{R}│'
    _43_Print = f'{IA}{R}│{E} └{Y} По умолчанию: {G}Нет                                  {O*4}{R}│'
    _44_Print = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
    _4_Name   = f'{IA}{B} URL Информация'
    _4_Input  = f'{IA}{E} └ {I}Значение: '

    _51_Print = f'{IA}{R}┌────────────────────────────────────────────{A*3}{E} Коментарий {R}─{R}┐'
    _52_Print = f'{IA}{R}│{I} Значения: {G}https://example.com                           {O*3}{R}│'
    _53_Print = f'{IA}{R}│{E} └{Q} Требуется обязательно!                                {O*3}{R}│'
    _54_Print = f'{IA}{R}└───────────────────────────────────────────────────────────────{A*1}{R}┘'
...
cn.print(f'{IA}{E}│{W} Название: {R}{R}{R}{R}{R}{____________________Имя[:45]} {Y}{Y}{Y}{E}│')
cn.print(f'{IA}{E}│{W} Возрасное ограниение: {R}{________________Возраст[:33]} {Y}{Y}{Y}{E}│')
cn.print(f'{IA}{E}└───────────────────────────────────────────────{Y} ID: {num} {E}─{E}{E}┘')
cn.print()
